...
namespace ElSaman.MVC.Controllers.API
{
    public class RatingAPIController:ControllerBase
    {
        ...
        [HttpPost]
        public ResultViewModel Add([FromBody]RatingEditViewModel model)
        {
        ...
        [HttpPost]
        public ResultViewModel Update([FromBody]RatingEditViewModel model, int ID = 0)
        {
            if (ModelState.IsValid == true)
            {
        ...
        [HttpPost]
        public ResultViewModel Remove([FromBody]RatingEditViewModel model, int ID)
        {
            if (ModelState.IsValid == true)
            {
