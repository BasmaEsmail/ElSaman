...
namespace ElSaman.MVC.Controllers.API
{
    public class UserAPIController:ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> ChangePassword([FromBody]ChangePasswardViewModel model)
        {
        ...
        [HttpPost]
        public async Task<ResultViewModel> Edit([FromBody] UserViewModel model)
        {
