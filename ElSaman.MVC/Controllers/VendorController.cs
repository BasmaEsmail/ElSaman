...
namespace ElSaman.MVC.Controllers
{
    public class VendorController:Controller
    {
        ...
        public VendorController(VendorRepository _vendorRepo, UnitOfWork _unitOfWork,
            ...
            MemberShipRepository _memberShipRepository, StoreRepository _storeRepository,
            ProductRepository productRepository, OrderItemRepository _orderListRepository)
        {
